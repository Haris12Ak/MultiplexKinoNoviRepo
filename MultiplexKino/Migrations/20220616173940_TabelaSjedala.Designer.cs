...
namespace MultiplexKino.Migrations
{
    ...
    [Migration("20220616173940_TabelaSjedala")]
    partial class TabelaSjedala
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MultiplexKino.Areas.Identity.Data.EntityModels.Sala", b =>
                {
                    ...
                    b.Property<int>("SjedalaId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("SjedalaId");
            ...
            modelBuilder.Entity("MultiplexKino.Areas.Identity.Data.EntityModels.Sala", b =>
                {
                    b.HasOne("MultiplexKino.Areas.Identity.Data.EntityModels.Sjedala", "Sjedala")
                        .WithMany("Sale")
                        .HasForeignKey("SjedalaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
